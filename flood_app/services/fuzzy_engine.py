...
class FuzzyRecommenderEngine:
    def __init__(self):
        self.system = _build_control_system()
    ...
    def compute_suitability(
        ...
        self.sim.input["capacity"] = capacity_val
        self.sim.input["distance"] = distance_val
        self.sim.input["accessibility"] = accessibility_val
        self.sim.input["elevation"] = elevation_val
        self.sim.input["proximity"] = proximity_val
        self.sim.input["medical"] = medical_val

        self.sim.compute()
        return self.sim.output["suitability"]
...
def get_fuzzy_simulator(
    ...
    """Legacy wrapper for single calls."""
    engine = FuzzyRecommenderEngine()
    return engine.compute_suitability(
        capacity_val,
        distance_val,
        accessibility_val,
        elevation_val,
